...
type ServiceUnitStatus struct {
	...
	// conditions represent the current state of the ServiceUnit resource.
...
type ServiceUnit struct {
	...
	// spec defines the desired state of ServiceUnit
	// +required
	Spec ServiceUnitSpec `json:"spec"`

	// status defines the observed state of ServiceUnit
	// +optional
	Status ServiceUnitStatus `json:"status,omitzero"`
}
